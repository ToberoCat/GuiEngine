...
import io.github.toberocat.guiengine.render.provided.WorkbenchGuiRenderEngine
 ...
 */
class WorkbenchInterpreter : ContainerInterpreter {
    override val interpreterId = "workbench"
    override val renderEngine = WorkbenchGuiRenderEngine()
