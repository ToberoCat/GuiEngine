 ...
 */
class EnchantingGuiRenderEngine : GuiRenderEngine {
    ...
    override fun createInventory(
        ...
        ?.let { Bukkit.createInventory(viewer, InventoryType.ENCHANTING, it.title) }

    override fun width(context: GuiContext) = 2
